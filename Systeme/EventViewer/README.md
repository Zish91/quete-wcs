...
La vue créer dans l'event viewer sert à la surveillance du rôle DNS mis en place plutôt.
Elle surveille 4 niveaux d'incidents de la plus Critique à la simple Informations.  
...
![Vue DNS-MONITORING](dns-monitoring1.png)
